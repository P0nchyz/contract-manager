...
export const S = {
  ...
  estimateForm: {
    ...
    cover: {
      ...
      anticipo: 'Anticipo',
      period: 'Período',
      periodSelector: 'Selecciona el período de esta estimación',
      periodDates: 'Fechas del período',
      noPeriods: 'No hay períodos disponibles (todos tienen estimación o el contrato no tiene programa).',
    },
    ...
    validation: {
      ...
      periodRequired: 'Selecciona el período de la estimación.',
