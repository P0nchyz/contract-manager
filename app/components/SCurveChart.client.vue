  ...
  datasets: [
    {
      ...
      borderWidth: 2,
      pointRadius: 2,
      pointBackgroundColor: colors.muted + '66',
      pointBorderWidth: 0,
      pointHoverRadius: 5,
      pointHoverBackgroundColor: colors.muted,
      pointHoverBorderColor: colors.muted,
    ...
    },
    {
      ...
      borderWidth: 2.5,
      pointRadius: 2,
      pointBackgroundColor: colors.primary + '66',
      pointBorderWidth: 0,
      pointHoverRadius: 5,
    ...
    },
    {
      ...
      borderDash: [3, 3],
      pointRadius: 2,
      pointBackgroundColor: colors.success + '66',
      pointBorderWidth: 0,
      pointHoverRadius: 5,
